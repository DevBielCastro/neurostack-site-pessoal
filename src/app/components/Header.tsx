...
// LanguageSwitcher foi removido, pois não é mais necessário
...
export default function Header() {
  ...
  return (
    <header className={`sticky top-0 z-50 border-b border-ns-card transition-colors duration-300 ${
      isOpen ? 'bg-ns-bg' : 'bg-ns-bg/80 backdrop-blur-sm'
    }`}>
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-4/5 max-w-sm bg-ns-bg p-6 shadow-2xl z-[60]"
